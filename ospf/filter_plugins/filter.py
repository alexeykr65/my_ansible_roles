...
class FilterModule(object):
    ...
    def filters():
        ...
        """
        return {
            "ios_run_conf_int_ospf": FilterModule.ios_run_conf_int_ospf,
    ...
    def ios_run_conf_int_ospf(text):
        ...
        reg_ospf = re.compile(intrf_ospf_pattern, re.VERBOSE)
        for intrf in items_intrf:
            if re.search('ospf', intrf['intrf_cont'], re.MULTILINE):
